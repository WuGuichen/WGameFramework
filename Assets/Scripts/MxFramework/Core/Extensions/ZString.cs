...
// Migrated: 2026-05-05 from WGame/Client/Assets/Scripts/Common/ZString.cs
// Namespace changed: WGame.Common → MxFramework.Core.Extensions
/*
 介绍：
 ...
 */
namespace MxFramework.Core.Extensions
{
    struct Byte8192
    {
    ...
    public class zstring
    {
        ...
        public unsafe static implicit operator zstring(float value)
        {
            ...
            long mul = (long)System.Math.Pow(10, DecimalAccuracy);
